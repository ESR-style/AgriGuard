...
const CropsData = () => {
  ...
  const crops = [
    { name: 'Wheat', image: 'src/assets/wheat.jpeg', description: 'Wheat is a cereal grain.', waterRequirement: '500-650 mm', fullDescription: 'Wheat is a grass widely cultivated for its seed, a grain which is a worldwide staple food.' },
    { name: 'Rice', image: 'src/assets/rice.jpeg', description: 'Rice is a staple food.', waterRequirement: '450-700 mm', fullDescription: 'Rice is the seed of the grass species Oryza sativa or Oryza glaberrima. As a cereal grain, it is the most widely consumed staple food for a large part of the world\'s human population, especially in Asia.' },
    { name: 'Coffee', image: 'src/assets/coffee.jpeg', description: 'Coffee is a brewed drink prepared from roasted coffee beans.', waterRequirement: '1500-2500 mm', fullDescription: 'Coffee is a brewed drink prepared from roasted coffee beans, the seeds of berries from certain Coffea species.' },
    { name: 'Tea', image: 'src/assets/tea.jpeg', description: 'Tea is an aromatic beverage commonly prepared by pouring hot water over cured leaves.', waterRequirement: '1200-1400 mm', fullDescription: 'Tea is an aromatic beverage commonly prepared by pouring hot or boiling water over cured or fresh leaves of Camellia sinensis, an evergreen shrub native to East Asia.' },
    { name: 'Pepper', image: 'src/assets/pepper.jpeg', description: 'Pepper is a flowering vine in the family Piperaceae.', waterRequirement: '2000-3000 mm', fullDescription: 'Pepper is a flowering vine in the family Piperaceae, cultivated for its fruit, known as a peppercorn, which is usually dried and used as a spice and seasoning.' },
    { name: 'Sugarcane', image: 'src/assets/shugarcane.jpeg', description: 'Sugarcane is a tropical, perennial grass.', waterRequirement: '1500-2500 mm', fullDescription: 'Sugarcane is a tropical, perennial grass that forms lateral shoots at the base to produce multiple stems, typically three to four meters high and about 5 cm in diameter.' },
    { name: 'Cotton', image: 'src/assets/cotton.jpeg', description: 'Cotton is a soft, fluffy staple fiber.', waterRequirement: '700-1300 mm', fullDescription: 'Cotton is a soft, fluffy staple fiber that grows in a boll, or protective case, around the seeds of cotton plants of the genus Gossypium in the mallow family Malvaceae.' },
    { name: 'Maize', image: 'src/assets/corn.jpeg', description: 'Maize is also known as corn.', waterRequirement: '500-800 mm', fullDescription: 'Maize, also known as corn, is a cereal grain first domesticated by indigenous peoples in southern Mexico about 10,000 years ago.' },
    { name: 'Barley', image: 'src/assets/barley.jpeg', description: 'Barley is a major cereal grain.', waterRequirement: '450-650 mm', fullDescription: 'Barley is a major cereal grain grown in temperate climates globally. It was one of the first cultivated grains, particularly in Eurasia as early as 10,000 years ago.' },
    { name: 'Millet', image: 'src/assets/millet.jpeg', description: 'Millet is a group of highly variable small-seeded grasses.', waterRequirement: '300-500 mm', fullDescription: 'Millet is a group of highly variable small-seeded grasses, widely grown around the world as cereal crops or grains for fodder and human food.' },
